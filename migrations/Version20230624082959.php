 ...
 */
final class Version20230624082959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercise ADD name VARCHAR(255) NOT NULL, ADD description VARCHAR(255) DEFAULT NULL');
    }
